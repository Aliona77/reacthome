...
export default class Tutors extends Component{
  ...
  handleSubmit = (e) => {
    const { isFormShow, lastName, firstName, patreonomic, phone, email, city } = this.state;
    e.preventDefault();
    console.log({
      isFormShow,
      lastName,
  ...
  render(){
    ...
    return (
      <Container>
        ...
        <TutorList />
        <Button text={isFormShow ? "Закрть форму" :"Добавить преподавателя"} onClick={this.toggleForm} />
        {isFormShow && (
          <Form onSubmit={this.handleSubmit}>
            <input type="text"
              name="lastName"
